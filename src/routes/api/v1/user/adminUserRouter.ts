...
import { userLoginSchema , passwordSchema , paramSchema , updateSchema, userRegisterSchema, commonSchema} from "@utils/validation/validationSchema";
...
router.post('/register', authMiddleware , adminMiddleware , validateRequestSchema , AdminUserController.register);
